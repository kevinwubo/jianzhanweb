...
namespace DataRepository.DataAccess.User
{
    public class UserStatement
    {
        ...
        public static string CreateNewUser = @"INSERT INTO [UserInfo]([UserName],[NickName],[RoleIDs],[Password],[GroupIDs],[Status],CityName,SalesCount,PrivateTelephone,Telephone,[CreateDate])
                VALUES (@UserName,@NickName,@RoleIDs,@Password,@GroupIDs,@Status,@CityName,@SalesCount,@PrivateTelephone,@Telephone,@CreateDate)";

        public static string ModifyUser = @"UPDATE [UserInfo]
                                               SET [UserName] =@UserName,[NickName]=@NickName,[RoleIDs]=@RoleIDs
                                                  ,[GroupIDs]=@GroupIDs
                                                  ,[Status] = @Status, PrivateTelephone = @PrivateTelephone, Telephone = @Telephone
